...
<body>
  ...
  <div class="row no-gutters mt-5">
    ...
    <div class="col-md-10 p-5 pt-4">
      <h3><i class="fa-solid fa-calendar-days"></i>&nbsp;&nbsp;EDIT JADWAL KULIAH</h3><hr>
      <div class="container">
            ...
            <div class="card-body">
                <form action="aksi-jd.php" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="sks" name="sks" value="<?=$jd['sks']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="matkul" class="col-sm-2 col-form-label">Mata Kuliah</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="matkul" name="matkul" value="<?=$jd['matkul']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="kode" class="col-sm-2 col-form-label">Kode Jadwal</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="kode" name="kode" value="<?=$jd['kode']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="dosen" class="col-sm-2 col-form-label">Dosen</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="dosen" name="dosen" value="<?=$jd['dosen']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="kelas" class="col-sm-2 col-form-label">Kelas</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="kelas" name="kelas" value="<?=$jd['kelas']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="ruang" class="col-sm-2 col-form-label">Ruang</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="ruang" name="ruang" value="<?=$jd['ruang']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="waktu" class="col-sm-2 col-form-label">Waktu</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="waktu" name="waktu" value="<?=$jd['waktu']?>" required="required">
                        </div>
                    </div>
                    <button class="btn btn-primary" name="submit-edt-jd">Edit</button>
                </form>
            </div>
        </div>
    </div>
