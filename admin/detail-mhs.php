...
<body>
  ...
  <div class="row no-gutters mt-5">
    ...
    <div class="col-md-10 p-5 pt-4">
      <h3><i class="fa-sharp fa-solid fa-graduation-cap"></i>&nbsp;&nbsp;DETAIL MAHASISWA</h3><hr>
      <div class="container">
        ...
        <ul class="list-group-flush">
            ...
            <li class="list-group-item">Asal : <?=$data['asal']?></li>
            <li class="list-group-item">IPK : <?=$data['ipk']?></li>
            
        </ul>
        <div class="card-footer text-right">
            <a href="mahasiswa.php" class="btn btn-warning">Kembali ke data mahasiswa</a>
        </div>
        </div>
    </div>
    </div>
