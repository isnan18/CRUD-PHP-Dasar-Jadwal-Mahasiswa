...
<body>
  ...
  <div class="row no-gutters mt-5">
    ...
    <div class="col-md-10 p-5 pt-4">
      ...
      <p class="text-right"><a href="add-jd.php" class="btn btn-info">Add Jadwal</a></p>
   <tr>
        <th>#</th>
        <th>SKS</th>
        <th>Mata Kuliah</th>
   ...
   <?php foreach ($result as $jd):?>
    <tr>
      ...
      <td><?= $jd["waktu"];?></td>
      <td>
            <a href="edit-jd.php?id=<?= $jd['id']?>" class="btn btn-secondary">Edit</a> |
            <a href="aksi-jd.php?del&id=<?= $jd['id']?>" class="btn btn-danger">Delete</a> 
        </td>
    </tr>
    <?php $i++?>
    <?php endforeach ;?>
