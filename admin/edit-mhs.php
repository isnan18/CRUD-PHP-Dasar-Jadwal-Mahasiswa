...
$id = $_GET['id'];
$query = "SELECT * FROM webti WHERE id=$id";
...
<body>
  ...
  <div class="row no-gutters mt-5">
    ...
    <div class="col-md-10 p-5 pt-4">
      <h3><i class="fa-sharp fa-solid fa-graduation-cap"></i>&nbsp;&nbsp;EDIT DATA MAHASISWA</h3><hr>
      <div class="container">
            ...
            <div class="card-body">
                <form action="aksi.php" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="nim" name="nim" value="<?=$mhs['nim']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nama" class="col-sm-2 col-form-label">Nama</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama" name="nama" value="<?=$mhs['nama']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="email" name="email" value="<?=$mhs['email']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="jurusan" class="col-sm-2 col-form-label">Jurusan</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="jurusan" name="jurusan" value="<?=$mhs['jurusan']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="jurusan" class="col-sm-2 col-form-label">Asal</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="asal" name="asal" value="<?=$mhs['asal']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="jurusan" class="col-sm-2 col-form-label">IPK</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="ipk" name="ipk" value="<?=$mhs['ipk']?>" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="jurusan" class="col-sm-2 col-form-label">Password</label>
                        <div class="col-sm-10">
                        <input type="password" class="form-control" id="password" name="password" value="<?=$mhs['password']?>" required="required" readonly>
                        </div>
                    </div>
                    <fieldset class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input class="form-check-input" type="radio" name="gender" id="gender" value="L" <?php if ($mhs['gender'] == 'L') echo 'checked'?>>
                            <label class="form-check-label" for="gender">
                                Laki-laki
                            </label>
                            </div>
                            <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="gender" value="P" <?php if ($mhs['gender'] == 'P') echo 'checked'?>>
                            <label class="form-check-label" for="gender">
                                Perempuan
                            </label>
                            </div>
