...
$query = "SELECT * FROM webti WHERE nama!='admin'";
...
<body>
  ...
  <div class="row no-gutters mt-5">
    ...
    <div class="col-md-10 p-5 pt-4">
      <h3><i class="fa-sharp fa-solid fa-graduation-cap"></i>&nbsp;&nbsp;DAFTAR MAHASISWA</h3><hr>
      <table class="table table-striped table-hover">
      <p class="text-right"><a href="add-mhs.php" class="btn btn-info">Add Mahasiswa</a></p>
   <tr>
        <th>#</th>
        <th>NIM</th>
        <th>Nama</th>
   ...
   <tr>
        ...
        <td><?= $mhs["asal"];?></td>
        <td>
            <a href="detail-mhs.php?id=<?= $mhs['id']?>" class="btn btn-warning">Detail</a> |
            <a href="edit-mhs.php?id=<?= $mhs['id']?>" class="btn btn-secondary">Edit</a> |
            <a href="aksi.php?del&id=<?= $mhs['id']?>" class="btn btn-danger">Delete</a> 
        </td>
   </tr>
   <?php $i++?>
   <?php endforeach; ?>
